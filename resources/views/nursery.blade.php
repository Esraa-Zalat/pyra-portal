...
<body>
    ...
    <!-- HERO -->
    <header class="hero">
        <img src="{{ asset('nursery/nursery.png') }}" alt="Pyramakerz — About hero">
    </header>
    ...
    <section class="container intro">
        <div class="intro-grid reveal">
            <div>
                <div class="eyebrow">Welcome to nursery Category</div>
                <h1 class="h1">Introducing young learners to STEAM through play.</h1>
            </div>
    ...
    <section class="container cards">
        <div class="grid">
            ...
            <article class="card">
                <div class="card-head">
                    <span class="icon"><img src="icons/labinah.png" alt="" width="20"></span>

                </div>
                <h3>Labinah Website</h3>
                <p>Nurturing curiosity, creativity, and confidence from the earliest years.</p>
                <div class="col-6">
