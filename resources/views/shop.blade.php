...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,200..900;1,200..900&display=swap"
        rel="stylesheet">
    <title>Shop Category | Pyramakerz</title>
...
<body>
    ...
    <!-- HERO -->
    <header class="hero">
        <img src="{{ asset('shop/shop.png') }}" alt="Pyramakerz — About hero">
    </header>
    ...
    <section class="container intro">
        <div class="intro-grid reveal">
            <div>
                <div class="eyebrow">Welcome to shop Category</div>
                <h1 class="h1">Your hub for STEAM kits and learning tools.</h1>
            </div>
    ...
    <section class="container cards">
        <div class="grid">
            ...
            <article class="card">
                <div class="card-head">
                    <span class="icon"><img src="icons/robota.png" alt="" width="20"></span>
            ...
            <article class="card">
                <div class="card-head">
                    <span class="icon"><img src="icons/alefbots.png" alt="" width="20"></span>
            ...
            <article class="card">
                <div class="card-head">
                    <span class="icon"><img src="icons/3d.png" alt="" width="20"></span>
            ...
            <article class="card">
                <div class="card-head">
                    <span class="icon"><img src="icons/play.png" alt="" width="20"></span>
